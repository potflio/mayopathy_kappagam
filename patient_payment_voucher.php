        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="patientCode" placeholder="Enter Patient Code">
                    </div>
                    <div class="mb-3">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="card" style="width: 18rem;">
                    <img src="assets/icons/patient_profile.png" class="card-img-top" alt="Patient Image">
                    <div class="card-body">
