...
<body>
    <div class="container mt-3">
        ...
        <h4 class="alert alert-success text-center">Machine Income</h2>
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-personal-tab" data-bs-toggle="pill" data-bs-target="#pills-personal" type="button" role="tab">Main Machine</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-hospital-tab" data-bs-toggle="pill" data-bs-target="#pills-hospital" type="button" role="tab">Fitting And Accessories</button>
                </li>
            </ul>
            <div class="row mb-4">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-personal" role="tabpanel">
                    <p><b>TOTAL NO OF MACHINE:</b><span>10</span></p>
                    <p><b>TOTAL AMOUNT RECIEVED:</b><span>$2050</span></p>
